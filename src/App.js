...
const SKILL_CATS = [
  ...
  { label:"ビジネス基礎", color:"#6B8CFF", icon:"💼", skills:["Excel","Word","PowerPoint","資料作成","スケジュール管理","議事録作成","事務処理","報連相","業務改善"] },
];
      ...
      {p1step === 4 && (
        <div>
          ...
          <button
            ...
            style={{ width:"100%", padding:"12px", background:"transparent", border:`1px solid ${C.border}`, borderRadius:12, color:C.muted, cursor:"pointer", fontSize:13, fontFamily:F }}>
            💾 いったん保存してマイページへ
          </button>
        </div>
      )}
